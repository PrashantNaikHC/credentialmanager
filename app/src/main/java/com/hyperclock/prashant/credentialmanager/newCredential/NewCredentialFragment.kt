...
//    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,savedInstanceState: Bundle?): View? {
        ...
        val viewModel = ViewModelProviders.of(this, viewModelFactory).get(NewCredentialViewModel::class.java)
        ...
        binding.floatingActionButton.setOnClickListener {
            val newCred = Credential(0L,binding.name.toString(),binding.password.toString(), 10 ,binding.link.toString())

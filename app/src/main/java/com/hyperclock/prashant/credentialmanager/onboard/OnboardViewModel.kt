...
class OnboardViewModel : ViewModel() {
    ...
    private var randomIntegerString = (0..9).shuffled()
    ...
    private var appendMin = DateFormat.format("m", date.getTime());
    ...
    private fun getfetchedPass() : String{
        fetchedPass=""
    ...
    private fun finalPassGen(): String? {
